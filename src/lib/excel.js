...
export function exportToExcel(data) {
  ...
  sheet("Venda Frutas", data.fruitSales.map(x => ({ Data: x.date, Produto: x.type, Comprador: x.buyer, Local: x.local || "", Entregou: x.entregador || "", Qtd: x.qty, Unid: x.unit, Kg: saleKg(x), "Preco Unit": x.unitPrice, Total: x.total, Situacao: x.payStatus === "recebido" ? "recebido" : "a receber", Forma: x.payMethod || "", "Dinheiro com": x.holder || "" })));
